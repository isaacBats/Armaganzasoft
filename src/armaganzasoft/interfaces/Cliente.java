...
cliente = new Customer();
        ...
        cliente.setName(jTextField2.getText());
        cliente.setLast_name(jTextField3.getText());
        cliente.setEmail(jTextField4.getText());
        cliente.setTelephone(jTextField5.getText());
        cliente.setMovil(jTextField6.getText());
        cliente.setRfc(jTextField7.getText());
        cliente.setAdress(jTextField8.getText());
        cliente.setCity(jTextField9.getText());
        cliente.setZip_code(jTextField10.getText());
        cliente.setSub_customer(jTextField11.getText());
        cliente.setCustomer_id(jTextField12.getText());
        
         CustomerRepository  customRepo = new CustomerRepository();
         
        if (customRepo.buscarCliente(cliente)!=null ){
         System.out.println("El cliente "+cliente.getIdentified()+" se ha encontrado");
            //JOptionPane.showMessageDialog(this,"DATOS INGRESADOS CORRECTAMENTE");
                   }else{
            System.out.println("El cliente "+cliente.getIdentified()+" no se ha encontrado");
...
Customer customer;
        ...
        customer.setAdress(jTextField8.getText());
        ...
        if( !customRepo.addCustom(customer) ){
            System.out.println("El cliente "+customer.getIdentified()+" se ha insertado Correctamente");
            JOptionPane.showMessageDialog(this,"DATOS INGRESADOS CORRECTAMENTE");
            limpiar();
        }else{
            System.out.println("El cliente "+customer.getIdentified()+" se ha insertado Correctamente");
